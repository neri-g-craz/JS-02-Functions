/*
Funciones. Son bloques de código con instrucciones que se pueden reutilizar las veces que sean necesarias. Algunas funciones reciben parámetros y otras no reciben parámetros.
...
//Ejecutar la función con el nombre de ka función y los parámetros.
saludar();
...
// Funciones flecha (Arrow function). Es una manera de declarar una función por expresión, sintetizando código y haciéndolo más legible.
...
//Callbacks. Es pasar una función B por parámetro a una funcion A, de modo que la función A pueda ejecutar esa función de forma genérica desde su código.
